function doMapping(input, ...mappings) {
    ...
    function doOneMapping(source, studyEventData, mapping, count) {
              ...
              if (gs.length > 0) {
                ...
                if(_fgs) {
                    ...
                    if(_v1) {
                        ...
                        _eachDestTree(studyEventData,"SCR","VS1","VS1","VSDTC",0,0,_v1);
                    }                }
                ...
                for (var _s =0; _s < _gs.length; _s++) {
                    ...
                    if(_it.length >0) {
                        ...
                        if(_val) {
                            _eachDestTree(studyEventData,"SCR","VS1","VS11","VSORRES",0,1,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"SCR","VS1","VS11","VSCLSIG",0,1,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"SCR","VS1","VS11","VSORRES",0,2,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSPULSEDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"SCR","VS1","VS11","VSCLSIG",0,2,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"SCR","VS1","VS11","VSORRES",0,3,_val);
                            _c++
                            _it = gs[0].items.filter((i) => i.itemName === "VSSYPRDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"SCR","VS1","VS11","VSCLSIG",0,3,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"SCR","VS1","VS11","VSORRES",0,4,_val);
                            _c++
                            _it = gs[0].items.filter((i) => i.itemName === "VSDIPRDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"SCR","VS1","VS11","VSCLSIG",0,4,_val1);
                            }
                        }
                    }
                    if (_c == 4) {
              ...
              if (gs.length > 0) {
                ...
                for (var _s =0; _s < _gs.length; _s++) {
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V1","VS3","VS11","VSORRES",0,1,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V1","VS3","VS11","VSCLSIG",0,1,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V1","VS3","VS11","VSORRES",0,2,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSPULSEDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V1","VS3","VS11","VSCLSIG",0,2,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V1","VS3","VS11","VSORRES",0,3,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSSYPRDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V1","VS3","VS11","VSCLSIG",0,3,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V1","VS3","VS11","VSORRES",0,4,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSDIPRDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V1","VS3","VS11","VSCLSIG",0,4,_val1);
                            }
                        }
                    }
                    if (_c == 4) {
              ...
              if (gs.length > 0) {
                ...
                for (var _s =0; _s < _gs.length; _s++) {
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V4","VS3","VS11","VSORRES",0,1,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V4","VS3","VS11","VSCLSIG",0,1,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V4","VS3","VS11","VSORRES",0,2,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSPULSEDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V4","VS3","VS11","VSCLSIG",0,2,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V4","VS3","VS11","VSORRES",0,3,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSSYPRDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V4","VS3","VS11","VSCLSIG",0,3,_val1);
                            }
                        }
                    }
                    ...
                    if(_it.length >0) {
                        let _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                        if(_val) {
                            _eachDestTree(studyEventData,"V4","VS3","VS11","VSORRES",0,4,_val);
                            _c++
                            _it = gs[_s].items.filter((i) => i.itemName === "VSDIPRDE");
                            _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                            if(_val1) {
                                _eachDestTree(studyEventData,"V4","VS3","VS11","VSCLSIG",0,4,_val1);
                            }
                        }
                    }
                    if (_c == 4) {
                ...
                for (var _s =0; _s < _gs.length; _s++) {
                    ...
                    if(_it.length > 0) {
                        ...
                        if(_val && _val == '服药前1h') {
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,1,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,1,_val1);
                                }

                                _it = gs[_s].items.filter((i) => i.itemName === "VSBETIM");
                                _val2 = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,1,_val2);
                                }
                            }
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,2,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,2,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,2,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,3,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,3,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,3,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,4,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,4,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,4,_val2);
                                }
                            }
                        ...
                        if(_val && _val == '服药后3h') {
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,5,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,5,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,5,_val2);
                                }
                            }
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,6,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,6,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,6,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,7,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,7,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,7,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,8,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,8,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,8,_val2);
                                }
                            }
                        }
                        ...
                        if(_val && _val == '服药后5h') {
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,9,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,9,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,9,_val2);
                                }
                            }
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,10,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,10,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,10,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,11,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,11,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,11,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,12,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,12,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,12,_val2);
                                }
                            }
                        }
                        ...
                        if(_val && _val == '服药后24h') {
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,13,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,13,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,13,_val2);
                                }
                            }
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,14,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,14,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,14,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,15,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,15,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,15,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,16,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,16,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,16,_val2);
                                }
                            }
                        }
                        ...
                        if(_val && _val == '服药后48h') {
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,17,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,17,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,17,_val2);
                                }
                            }
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,18,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,18,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,18,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,19,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,19,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,19,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,20,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,20,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,20,_val2);
                                }
                            }
                        }
                        ...
                        if(_val && _val == '服药后72h') {
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,21,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,21,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,21,_val2);
                                }
                            }
                            ...
                            _val = _it.length>0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,22,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,22,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,22,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,23,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,23,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,23,_val2);
                                }
                            }
                            ...
                            _val = _it.length > 0 && _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                            if(_val) {
                                _eachDestTree(studyEventData,"V3","VS2","VS2","VSORRES",0,24,_val);

                                _it = gs[_s].items.filter((i) => i.itemName === "VSREDE");
                                _val = _it[0]["rawValue"] ?  _it[0]["rawValue"] : ''
                                _val1 = _val == '0' ? "正常" :  _val == '1' ? "异常，无临床意义" : _val == '2' ? "异常，有临床意义" :  _val == '3' ? "" : ""
                                if(_val1) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSCLSIG",0,24,_val1);
                                }
                                ...
                                _val2 =  moment(parseInt(_val2)).format("YYYY-MM-DD HH:mm:ss")
                                if(_val2) {
                                    _eachDestTree(studyEventData,"V3","VS2","VS2","VSDTC",0,24,_val2);
                                }
                            }
                        }
      ...
      retrievedArray.forEach((r) => {
        ...
        if (r.item.dataType === "datetime" || r.item.dataType === "date" || r.item.dataType === "DatePicker"  || r.item.dataType === "ReferenceTime" || r.item.dataType === "TimePicker" ) {
